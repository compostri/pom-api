 ...
 */
final class Version20191217164440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_FCFE9BACF09D5957 ON composter (financeur_suivi_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE composter DROP financeur_suivi_id');
    }
}
